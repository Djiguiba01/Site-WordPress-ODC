...
if ( !defined( 'WPSL_EXT_SECTION_PREFIX' ) ) {
    define( 'WPSL_EXT_SECTION_PREFIX', 'wpsl_' );
}
if ( !defined( 'WPSL_EXT_SECTION_PARAM' ) ) {
    define( 'WPSL_EXT_SECTION_PARAM', 'wpsl_ext_section' );
}
if ( !defined( 'WPSL_EXT_SECTION_ALL' ) ) {
    define( 'WPSL_EXT_SECTION_ALL', 'wpsl_ext_section_all' );
}
//
if ( !defined( 'WPSL_EXT_SECTION_EXT' ) ) {
    define( 'WPSL_EXT_SECTION_EXT', 'wpsl_ext_section_general' );
}
//
if ( !defined( 'WPSL_EXT_SECTION_UML' ) ) {
    define( 'WPSL_EXT_SECTION_UML', 'wpsl_ext_section_usermanaged' );
}
if ( !defined( 'WPSL_EXT_SECTION_SETTINGS' ) ) {
    define( 'WPSL_EXT_SECTION_SETTINGS', 'wpsl_ext_section_settings' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_TEXT' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_TEXT', 'wpsl_ext_text' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_TEXTAREA' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_TEXTAREA', 'wpsl_ext_textarea' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_CHECKBOX' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_CHECKBOX', 'wpsl_ext_checkbox' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_DROPDOWN' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_DROPDOWN', 'wpsl_ext_dropdown' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_SUBHEADER' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_SUBHEADER', 'wpsl_ext_subheader' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_READONLY' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_READONLY', 'wpsl_ext_readonly' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_BUTTON' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_BUTTON', 'wpsl_ext_button' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_CUSTOM' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_CUSTOM', 'wpsl_ext_custom' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_ICONLIST' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_ICONLIST', 'wpsl_ext_iconlist' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_HIDDEN' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_HIDDEN', 'wpsl_ext_hidden' );
}
if ( !defined( 'WPSL_EXT_SETTINGS_TYPE_DATETIME' ) ) {
    define( 'WPSL_EXT_SETTINGS_TYPE_DATETIME', 'wpsl_ext_datetime' );
}
if ( !defined( 'WPSL_EXT_STORE_USER_SLUG' ) ) {
    define( 'WPSL_EXT_STORE_USER_SLUG', 'users' );
}
if ( !defined( 'WPSL_EXT_STORE_USER_COL_ALLOWED' ) ) {
    define( 'WPSL_EXT_STORE_USER_COL_ALLOWED', 'wpsl_user_col_allowed' );
}
if ( !defined( 'WPSL_EXT_STORE_USER_COL_LOCATIONS' ) ) {
    define( 'WPSL_EXT_STORE_USER_COL_LOCATIONS', 'wpsl_user_col_locations' );
}
if ( !defined( 'WPSL_EXT_CAP_MANAGE_WPSL' ) ) {
    define( 'WPSL_EXT_CAP_MANAGE_WPSL', 'wpsl_store_locator_manager' );
}
if ( !defined( 'WPSL_EXT_CAP_MANAGE_WPSL_ADMIN' ) ) {
    define( 'WPSL_EXT_CAP_MANAGE_WPSL_ADMIN', 'wpsl_store_locator_admin' );
}
if ( !defined( 'WPSL_EXT_CAP_MANAGE_WPSL_SETTINGS' ) ) {
    define( 'WPSL_EXT_CAP_MANAGE_WPSL_SETTINGS', 'manage_wpsl_settings' );
}
if ( !defined( 'WPSL_EXT_CAP_MANAGE_WPSL_USER' ) ) {
    define( 'WPSL_EXT_CAP_MANAGE_WPSL_USER', 'wpsl_store_locator_user' );
}
if ( !defined( 'WPSL_EXT_ACTION_SAVE' ) ) {
    define( 'WPSL_EXT_ACTION_SAVE', 'wpsl_ext_action_save' );
}
if ( !defined( 'WPSL_EXT_ACTION_UPDATE' ) ) {
    define( 'WPSL_EXT_ACTION_UPDATE', 'wpsl_ext_action_update' );
}
if ( !defined( 'WPSL_EXT_ACTION_REQUEST' ) ) {
    define( 'WPSL_EXT_ACTION_REQUEST', 'wpsl_ext_action_request' );
}
if ( !defined( 'WPSL_EXT_ACTION_SETTINGS' ) ) {
    define( 'WPSL_EXT_ACTION_SETTINGS', 'wpsl_ext_action_settings' );
}
if ( !defined( 'WPSL_EXT_ACTION_USER_ALLOW' ) ) {
    define( 'WPSL_EXT_ACTION_USER_ALLOW', 'wpsl_ext_action_user_allow' );
}
if ( !defined( 'WPSL_EXT_ACTION_USER_DISALLOW' ) ) {
    define( 'WPSL_EXT_ACTION_USER_DISALLOW', 'wpsl_ext_action_user_disallow' );
}
if ( !defined( 'WPSL_EXT_ACTION_STORE_SEARCH' ) ) {
    define( 'WPSL_EXT_ACTION_STORE_SEARCH', 'store_search' );
}
if ( !defined( 'WPSL_EXT_NOTICE_SUCCESS' ) ) {
    define( 'WPSL_EXT_NOTICE_SUCCESS', 'success' );
}
if ( !defined( 'WPSL_EXT_NOTICE_INFO' ) ) {
    define( 'WPSL_EXT_NOTICE_INFO', 'info' );
}
if ( !defined( 'WPSL_EXT_NOTICE_WARNING' ) ) {
    define( 'WPSL_EXT_NOTICE_WARNING', 'warning' );
}
if ( !defined( 'WPSL_EXT_NOTICE_ERROR' ) ) {
    define( 'WPSL_EXT_NOTICE_ERROR', 'error' );
}
